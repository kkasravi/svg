  ...
  (function(require, exports, moduleId) {
    ...
    var Defs = (function() {
      ...
      Defs.prototype['defs'] = function(composer) {
        if(composer) {
          ...
          var node=this.type=current || document.createElementNS(composer.getSvgNS(),'defs');
    ...
    var G = (function() {
      ...
      G.prototype['g'] = function(composer,attrs) {
        var node;
        if(attrs) {
          node=this.type=document.createElementNS(composer.getSvgNS(),'g');
          composer.top().appendChild(node);
          composer.push(node);
    ...
    var Animate = (function() {
      ...
      Animate.prototype['animate'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'animate');
    ...
    var AnimateColor = (function() {
      ...
      AnimateColor.prototype['animateColor'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'animateColor');
        composer.top().appendChild(this.type);
        this.setAttributes(composer,attrs);
        return this;
      };
    ...
    var AnimateMotion = (function() {
      ...
      AnimateMotion.prototype['animateMotion'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'animateMotion');
        composer.top().appendChild(this.type);
        this.setAttributes(composer,attrs);
        return this;
      };
    ...
    var AnimateTransform = (function() {
      ...
      AnimateTransform.prototype['animateTransform'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'animateTransform');
        composer.top().appendChild(this.type);
        this.setAttributes(composer,attrs);
        return this;
      };
    ...
    var Circle = (function() {
      ...
      Circle.prototype['circle'] = function(composer,attrs) {
        var node;
        if(attrs) {
          node=this.type=document.createElementNS(composer.getSvgNS(),'circle');
          composer.top().appendChild(node);
          composer.push(node);
          this.setAttributes(composer,attrs);
        } else {
    ...
    var ClipPath = (function() {
      ...
      ClipPath.prototype['clipPath'] = function(composer,attrs) {
        var node;
        if(attrs) {
          this.type=document.createElementNS(composer.getSvgNS(),'clipPath');
          node=this.type;
          composer.top().appendChild(node);
          composer.push(node);
          this.setAttributes(composer,attrs);
    ...
    var Ellipse = (function() {
      ...
      Ellipse.prototype['ellipse'] = function(composer,attrs) {
        var node;
        if(attrs) {
          this.type=document.createElementNS(composer.getSvgNS(),'ellipse');
          node=this.type;
          composer.top().appendChild(node);
          composer.push(node);
          this.setAttributes(composer,attrs);
    ...
    var FeBlend = (function() {
      ...
      FeBlend.prototype['feBlend'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'feBlend');
        composer.top().appendChild(this.type);
        this.setAttributes(composer,attrs);
        return this;
      };
    ...
    var FeComponentTransfer = (function() {
      ...
      FeComponentTransfer.prototype['feComponentTransfer'] = function(composer,attrs) {
        var node;
        if(attrs) {
          this.type=document.createElementNS(composer.getSvgNS(),'feComponentTransfer');
          node=this.type;
          composer.top().appendChild(node);
          composer.push(node);
          this.setAttributes(composer,attrs);
    ...
    var FeComposite = (function() {
      ...
      FeComposite.prototype['feComposite'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'feComposite');
        composer.top().appendChild(this.type);
        this.setAttributes(composer,attrs);
        return this;
      };
    ...
    var FeDiffuseLighting = (function() {
      ...
      FeDiffuseLighting.prototype['feDiffuseLighting'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'feDiffuseLighting');
        var node=this.type;
        composer.top().appendChild(node);
        composer.push(node);
        this.setAttributes(composer,attrs);
    ...
    var FeDisplacementMap = (function() {
      ...
      FeDisplacementMap.prototype['feDisplacementMap'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'feDisplacementMap');
        composer.top().appendChild(this.type);
        this.setAttributes(composer,attrs);
        return this;
      };
    ...
    var FeFlood = (function() {
      ...
      FeFlood.prototype['feFlood'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'feFlood');
        composer.top().appendChild(this.type);
        this.setAttributes(composer,attrs);
        return this;
      };
    ...
    var FeFuncA = (function() {
      ...
      FeFuncA.prototype['feFuncA'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'feFuncA');
        composer.top().appendChild(this.type);
        this.setAttributes(composer,attrs);
        return this;
      };
    ...
    var FeImage = (function() {
      ...
      FeImage.prototype['feImage'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'feImage');
        composer.top().appendChild(this.type);
        this.setAttributes(composer,attrs);
        return this;
      };
    ...
    var FeGuassianBlur = (function() {
      FeGuassianBlur.prototype = exports.SvgType();
      FeGuassianBlur.prototype.constructor = FeGuassianBlur;
      var SvgType = exports.SvgType.constructor;
      function FeGuassianBlur() {
        var args = Array.prototype.slice.call(arguments);
        var ctor = function (_properties) {
          var properties = _properties || {};
          SvgType.call(this,properties);
      ...
      FeGuassianBlur.prototype['feGaussianBlur'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'feGaussianBlur');
        composer.top().appendChild(this.type);
        this.setAttributes(composer,attrs);
        return this;
      };
      return function __() {
        var args = Array.prototype.slice.call(arguments);
        __.constructor = FeGuassianBlur;
        return new FeGuassianBlur(args && args.length && args[0]);
      };
    })();
    exports.FeGuassianBlur = FeGuassianBlur;
    var FeMerge = (function() {
      ...
      FeMerge.prototype['feMerge'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'feMerge');
        composer.top().appendChild(this.type);
    ...
    var FeMergeNode = (function() {
      ...
      FeMergeNode.prototype['feMergeNode'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'feMergeNode');
        composer.top().appendChild(this.type);
        this.setAttributes(composer,attrs);
        return this;
      };
    ...
    var FeOffset = (function() {
      ...
      FeOffset.prototype['feOffset'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'feOffset');
        composer.top().appendChild(this.type);
        this.setAttributes(composer,attrs);
        return this;
      };
    ...
    var FePointLight = (function() {
      ...
      FePointLight.prototype['fePointLight'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'fePointLight');
        composer.top().appendChild(this.type);
        this.setAttributes(composer,attrs);
        return this;
      };
    ...
    var FeSpecularLighting = (function() {
      ...
      FeSpecularLighting.prototype['feSpecularLighting'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'feSpecularLighting');
        composer.top().appendChild(this.type);
        composer.push(this.type);
        this.setAttributes(composer,attrs);
        return this;
    ...
    var FeTile = (function() {
      ...
      FeTile.prototype['feTile'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'feTile');
        composer.top().appendChild(this.type);
        composer.push(this.type);
        this.setAttributes(composer,attrs);
        return this;
    ...
    var FeTransform = (function() {
      ...
      FeTransform.prototype['feTransform'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'feTransform');
        composer.top().appendChild(this.type);
        this.setAttributes(composer,attrs);
        return this;
      };
    ...
    var FeTurbulence = (function() {
      ...
      FeTurbulence.prototype['feTurbulence'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'feTurbulence');
        composer.top().appendChild(this.type);
        this.setAttributes(composer,attrs);
        return this;
      };
    ...
    var Filter = (function() {
      ...
      Filter.prototype['filter'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'filter');
        composer.top().appendChild(this.type);
        composer.push(this.type);
        this.setAttributes(composer,attrs);
        return this;
    ...
    var Line = (function() {
      ...
      Line.prototype['line'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'line');
        composer.top().appendChild(this.type);
        composer.push(this.type);
        this.setAttributes(composer,attrs);
        return this;
    ...
    var LinearGradient = (function() {
      ...
      LinearGradient.prototype['linearGradient'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'linearGradient');
        composer.top().appendChild(this.type);
        composer.push(this.type);
        this.setAttributes(composer,attrs);
        return this;
    ...
    var Marker = (function() {
      ...
      Marker.prototype['marker'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'marker');
        composer.top().appendChild(this.type);
        composer.push(this.type);
        this.setAttributes(composer,attrs);
        return this;
    ...
    var Path = (function() {
      ...
      Path.prototype['path'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'path');
        composer.top().appendChild(this.type);
        composer.push(this.type);
        this.setAttributes(composer,attrs);
        return this;
    ...
    var Pattern = (function() {
      ...
      Pattern.prototype['pattern'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'pattern');
        composer.top().appendChild(this.type);
        composer.push(this.type);
        this.setAttributes(composer,attrs);
        return this;
    ...
    var Polygon = (function() {
      ...
      Polygon.prototype['polygon'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'polygon');
        composer.top().appendChild(this.type);
        this.setAttributes(composer,attrs);
        return this;
      };
    ...
    var RadialGradient = (function() {
      ...
      RadialGradient.prototype['radialGradient'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'radialGradient');
        composer.top().appendChild(this.type);
        composer.push(this.type);
        this.setAttributes(composer,attrs);
        return this;
    ...
    var Rect = (function() {
      ...
      Rect.prototype['rect'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'rect');
        composer.top().appendChild(this.type);
        composer.push(this.type);
        this.setAttributes(composer,attrs);
        return this;
    ...
    var Stop = (function() {
      ...
      Stop.prototype['stop'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'stop');
        composer.top().appendChild(this.type);
        composer.push(this.type);
        this.setAttributes(composer,attrs);
        return this;
    ...
    var Text = (function() {
      ...
      Text.prototype['text'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'text');
        composer.top().appendChild(this.type);
        composer.push(this.type);
        this.setAttributes(composer,attrs);
        return this;
    ...
    var TextArea = (function() {
      ...
      TextArea.prototype['textArea'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'textArea');
        composer.top().appendChild(this.type);
        composer.push(this.type);
        this.setAttributes(composer,attrs);
        return this;
    ...
    var TextPath = (function() {
      ...
      TextPath.prototype['textPath'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'textPath');
        composer.top().appendChild(this.type);
        this.setAttributes(composer,attrs);
        return this;
      };
    ...
    var Tspan = (function() {
      ...
      Tspan.prototype['tspan'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'tspan');
        composer.top().appendChild(this.type);
    ...
    var Ellipse = (function() {
      ...
      Ellipse.prototype['use'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.getSvgNS(),'use');
        composer.top().appendChild(this.type);
        this.setAttributes(composer,attrs);
        return this;
      };
    ...
    var Svg = (function() {
      ...
      function Svg() {
        ...
        var ctor = function (_properties) {
          ...
          this.stack=utilities.Stack().push(svg);
          this.svg=null;
