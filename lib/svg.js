  ...
  (function(require, exports, moduleId) {
      ...
      SvgType.prototype['setAttributes'] = function(composer,attrs) {
        ...
        for(attr in attrs) {
          if(attr === 'text') {
            ...
            this.type.setAttributeNS(composer.xlinkNS,"href",attrs[attr]);
          } else {
      ...
      AnimateMotion.prototype['animateMotion'] = function(composer,attrs) {
        ...
        if(attrs) {
          ...
          node=SVGable({
            element:composer.top(),
            svg:composer.svg
          }).on('load').children('animateMotion');
          node && node.length && composer.push(node[0]);
        }
        return this;
      };
      ...
      AnimateTransform.prototype['animateTransform'] = function(composer,attrs) {
        ...
        if(attrs) {
          ...
          node=SVGable({
            element:composer.top(),
            svg:composer.svg
          }).on('load').children('animateTransform');
          node && node.length && composer.push(node[0]);
        }
        return this;
      };
    ...
    var Circle = (function() {
      ...
      Circle.prototype['circle'] = function(composer,attrs) {
        var node;
        if(attrs) {
          this.type=document.createElementNS(composer.svgNS,'circle');
          this.setAttributes(composer,attrs);
          node=this.type;
          composer.top().appendChild(node);
          composer.push(node);
    ...
    var Mpath = (function() {
      Mpath.prototype = exports.SvgType();
      ...
      Mpath.prototype['mpath'] = function(composer,attrs) {
        this.type=document.createElementNS(composer.svgNS,'mpath');
        composer.top().appendChild(this.type);
        composer.push(this.type);
        this.setAttributes(composer,attrs);
        return this;
      ...
      return function __() {
        var args = Array.prototype.slice.call(arguments);
        __.constructor = Mpath;
        return new Mpath(args && args.length && args[0]);
      };
    })();
    exports.Mpath = Mpath;
    var Path = (function() {
    ...
    var Svg = (function() {
      ...
      Svg.prototype['setXlinkNS'] = function() {
        this.svg && this.svg.setAttribute("xmlns:xlink",this.xlinkNS);
        return this;
      };
